...
|`header-logo-left-url`|Add a path/url to the left logo|
|`header-logo-right-url`|Add a path/url to the right logo|
...
- [Demo with left logo and custom height](tests/demo-left-height/index.html)
- [Demo with three logos](tests/demo-default/index.html)
- [Demo with both logos and relative links](tests/demo-relative-link/index.html)
